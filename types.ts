...
export type NotificationType = 'like_post' | 'comment_post' | 'new_message' | 'like_product' | 'comment_product' | 'new_store_follower' | 'new_store_rating' | 'new_follower' | 'like_rental_post' | 'comment_rental_post';
